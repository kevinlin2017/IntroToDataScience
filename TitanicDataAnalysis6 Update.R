#
# Updated on 3/26/2018 update all fields with Capital Letters. For example, sibsp => SisSp. 
# This is because Titanic data fields have been changed
#
...
# Removd those codes in video 1 & 2
...
# Train a Random Forest using pclass, title, Fare, & family.size
rf.train.8 <- data.combined[1:891, c("Pclass", "Title", "Fare", "Family.size")]
